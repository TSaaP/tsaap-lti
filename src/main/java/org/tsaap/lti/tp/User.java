...
public class User {
    ...
    public static final String USER_DEFAULT_FIRSTNAME = "User";
    /**
     * User's first name.
     */
    ...
    /**
     * Default constructor introduced for testability
     */
     ...
     */
    public String getIdForDefaultScope() {
        return getId(null);
    }
    ...
    public void setNames(String firstname, String lastname, String fullname) {
        ...
        if ((firstname != null) && (firstname.length() > 0)) {
            ...
            this.firstname = USER_DEFAULT_FIRSTNAME;
        }
    ...
    public void setEmail(String email, String defaultEmail) {
        ...
        if ((email != null) && (email.length() > 0)) {
            ...
            if (this.email.startsWith("@")) {
                this.email = this.getIdForDefaultScope() + this.email;
            }
        } else {
            this.email = "";
        }
